...
{
    #[Route(path: "part/{code}", name: "search_part_by_code", methods: ["GET"])]
    public function searchPartByNumber(PartSearchQueryDataQuery $partSearchQueryDataQuery, string $catalogId,
